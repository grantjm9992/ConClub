...
<html lang="en">
    ...
    <body style="background: url(img/bg1.jpg); background-size: cover; background-repeat: none;">
	...
	<div style="position: absolute; bottom: 40px; right: 40px; width: 400px;" class="card">
